            ...
            <div class="container ">
                <form action="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button class="btn btn-block btn-primary btn-gradient" id="BtnSearch"> <i class="fa fa-search"></i>
                                {{ __('home.find_button') }}
                            </button>
                        </div>
                    </div>
                        ...
                        <div class="inner-box">
                            <div class=" list-filter">
                                ...
                                <div class="filter-date filter-content">
                                    <ul>
                                        <li>
                                            <input type="radio" class="daysCheck" value="1" id="posted_1" name="posted">
                                            <label for="posted_1">24 {{ __('home.hours') }}</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="daysCheck" value="3" id="posted_3" name="posted">
                                            <label for="posted_3">3 {{ __('home.days') }}</label>
                                        </li>
                                        <li>
                                            <input type="radio" class="daysCheck" value="7" id="posted_7" name="posted">
                                            <label for="posted_7">7 {{ __('home.days') }}</label>
                                        </li>
                                        <li>
                                            <input type="radio" checked="checked" class="daysCheck" value="30" id="posted_30" name="posted">
                            ...
                            <div class="list-filter">
                                <h5 class="list-title"><strong><a href="#">{{ __('home.employment_type') }}</a></strong>
                                </h5>
                                    ...
                                    <ul class="browse-list list-unstyled">
                                        ...
                                        @foreach ($jobTypes as $type)
                                            <li>
                                                ...
                                                <span class="badge badge-secondary">{{ $type->jobs->where('status',1)->count() }}</span>
                                            </li>
                                        @endforeach
                                    </ul>
                                </div> 
                                ...
                                <div class="filter-salary filter-content ">
                                    <form role="form" class="form-inline" action="{{ route('jobs.searchBetween') }}">
                                        <div class="form-group col-lg-4 col-md-12 no-padding">
                                            <input type="text" placeholder="$ 2000 " id="minPrice" name="minSalary"
                                                class="form-control">
                                        </div>
                                        <div class="form-group col-lg-1 col-md-12 no-padding text-center hidden-md"> -</div>
                                        <div class="form-group col-lg-4 col-md-12 no-padding">

                                            <input type="text" placeholder="$ 3000 " id="maxPrice" name="maxSalary"
                                                class="form-control">
                                        </div>
                                    ...
                                    <ul class="mt15">
                                        <li>
                                            <input type="radio" name="pay" id="payAll" value="0" class="payAll" checked="checked">
                                        ...
                                        <li>
                                            <input type="radio" name="pay" class="pay" id="pay_60" value="100000">
                                            <label for="pay_60">$100,000+</label>
                                        </li>
                                        <li>
                                            <input type="radio" name="pay" class="pay" id="pay_80" value="200000">
                                            <label for="pay_80">$200,000+</label>
                                        </li>
                                        <li>
                                            <input type="radio" name="pay" class="pay" id="pay_100" value="500000">
                                            <label for="pay_100">$500,000+</label>
                                        </li>
                                        <li>
                                            <input type="radio" name="pay" class="pay" id="pay_120" value="1000000">
                            ...
                            <div class="locations-list  list-filter">
                                ...
                                <ul class="browse-list list-unstyled long-list">
                                    @foreach ($cities as $city)
                                        <li><a href="job-list.html">{{ $city->name }} <span class="count">
                                                    {{ $city->jobs->count() }}</span></a></li>
                                    @endforeach
                                </ul>
                            </div>
                            <!--/.locations-list-->
                ...
                <div class="col-md-9 page-content col-thin-left">
                    ...
                    <div class="category-list">
                        ...
                        <div id="loader" style="display: none; position: absolute; margin-top:10%; z-index:9">
                            <img id="loader" src="{{ asset('ajax-loader.gif') }}" alt="loader" srcset="" height="60px" width="60px"
                            class="">
                        </div>
                    </div>
{{-- 
